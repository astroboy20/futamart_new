...
import { useFetchItems, BASE_URL } from "@/hooks/useFetchItems";
...
export default function Page() {
  ...
  const {
    ...
    url: `${BASE_URL}/products_by_query?query=top-rated&page=${page}`,
  });

  const totalPages = bestRated?.data?.totalPages || 1;
